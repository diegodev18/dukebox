...
import { authenticateDevice, issuePairingCode, redeemPairingCode } from '../auth/pairing.js'
...
import { attachWebSocketServer, disconnectDevice, tokenFromRequest } from './server.js'
