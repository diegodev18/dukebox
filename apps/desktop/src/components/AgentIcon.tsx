/**
 * Brand mark for a session's agent.
 *
 * Replaces the raw `agentId` string in the session header so Claude Code,
 * Codex, OpenCode, and Cursor CLI are recognizable at a glance.
 */
